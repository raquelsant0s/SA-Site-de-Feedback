...
<body link="black" alink="black" vlink="black">
    ...
    <header >
        ...
        <ul>
            <!-- <li> <a href="views/users/usuarios.php"> HOME </a> </li> -->
            <li> <a href="././views/sobre/suporte.php"> SOBRE </a> </li>
            <li> <a href="./controller/UsuarioController.php?logout=true"> LOGOUT </a> </li>
            <li><form action="views/alterar/index.php" method="post" name="id_edit">
            <input type="hidden" id="id_edit" name="id_edit" value="<?= $usuario->getID() ?>"/>
            <button type="submit">  ALTERAR CADASTRO </button></form></li>    
        </ul>
    </header>
    ...
    <main>
        ...
        <?php foreach ($produtodao->listarp() as $produto) : ?>
                ...
                <div id="prod">
                    ...
                    <form action="views/avaliacao/index.php" method="post" name="del">
                        <input type="hidden" id="id_feed" name="id_feed" value="<?= $produto->getID()?>"/>
                        <button style="background-color: #FFF; color:#00f;" id="feed" name="feed"> Ler as Avaliações </button>
                    </form>
                    <!-- <a href="views/avaliacao/index.php?alter="> Ler as Avaliações </a></button> -->
                </div>
